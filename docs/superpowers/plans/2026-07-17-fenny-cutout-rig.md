...
`ConfigureAtlas()` sets Sprite Multiple mode, bilinear filtering, no mipmaps, alpha transparency, FullRect meshes, and 21 `SpriteMetaData` entries. Use row-major cell coordinates and semantic names. Assign joint-oriented pivots:
